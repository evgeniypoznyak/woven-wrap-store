    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="text-navy-light font-medium tracking-wider text-sm">TESTIMONIALS</span>
          <h2 className="font-serif text-3xl md:text-4xl mt-2 text-navy-dark">What Our Customers Say</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-navy-lightest p-8 rounded-xl"
            >
              <div className="mb-4 text-navy-light">
              ...
              <p className="text-navy-medium mb-6 italic">{testimonial.quote}</p>
              <div>
                <p className="font-medium text-navy-dark">{testimonial.author}</p>
                <p className="text-sm text-navy-medium">{testimonial.location}</p>
              </div>
            </div>
          ))}
        </div>
